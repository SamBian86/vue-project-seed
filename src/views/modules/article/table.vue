    ...
    >
      ...
      <template slot="search">
        ...
        >
          <el-form-item>
            <el-input
              v-model="tableSearchParams.title"
...
import { getArticlePageList, deleteArticle } from '@/api/article'
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 公告标题
        { prop: 'title', label: 'article.title', width: '200' },
        // 文章内容
        { prop: 'content', label: 'article.content' },
        // 发布人
        { prop: 'publisher', label: 'article.publisher', width: '120' },
        // 发布时间
        { prop: 'createDate', label: 'article.createDate', width: '160' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      // 配置列表请求
      this.tableHandle.list.api = getArticlePageList
      // this.tableHandle.list.callback = this.listCallback
      // 配置导出功能
      // this.tableHandle.export.api = exportXXX
      // 配置删除功能
      this.tableHandle.delete.api = deleteArticle
      // this.tableHandle.delete.callback = this.deleteCallback
      // 配置节点懒加载功能
      // this.tableHandle.lazy.api = lazyXXX
      // 配置section删除功能
      // this.tableHandle.deleteSection.api = deleteArticle
