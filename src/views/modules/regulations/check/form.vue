      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('regulations:check:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('regulations:check:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
...
import { getRegulationsCheckById } from '@/api/regulations/check'
      ...
      this.formConfig.formItemsReadOnly = [
        {
          // 分割线
          span: 24,
          name: 'regulationsCheck.baseInfo',
          type: 'divider'
        },
        {
          // 检查时间
          span: 24,
          prop: 'createDate',
          name: 'regulationsCheck.createDate',
          type: 'text'
        },
        {
          // 检查人
          span: 24,
          prop: 'userName',
          name: 'regulationsCheck.userName',
          type: 'text'
        },
        {
          // 宿舍
          span: 24,
          prop: 'roomName',
          name: 'regulationsCheck.roomName',
          type: 'text'
        },
        {
          // 分割线
          span: 24,
          name: 'regulationsCheck.otherInfo',
          type: 'divider'
        },
        {
          // 违章人
          span: 24,
          prop: 'studentName',
          name: 'regulationsCheck.studentName',
          type: 'text'
        },
        {
          // 违章物品
          span: 24,
          prop: 'regulationsGoods',
          name: 'regulationsCheck.regulationsGoods',
          type: 'text'
        }
      ]
