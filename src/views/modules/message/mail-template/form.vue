...
import { createMessageMailtemplate, editMessageMailtemplate, getMessageMailtemplateById } from '@/api/message/mailtemplate'
  ...
  data() {
    return {
      ...
      formHandle: {
        // 创建抽象方法，用创建接口方法覆盖
        create: {
          api: createMessageMailtemplate
        },
        // 修改抽象方法，用修改接口方法覆盖
        edit: {
          api: editMessageMailtemplate
        },
        // 详情抽象方法，用详情接口方法覆盖
        detail: {
          api: getMessageMailtemplateById
        }
      },
      // 初始化数据定义
      formDefaultData: {},
