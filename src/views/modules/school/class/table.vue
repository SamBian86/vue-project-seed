        ...
        >
          <el-form-item>
            <el-select
              ...
              :placeholder="$t('schoolClass.branchId')"
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('schoolClass.className')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('schoolClass.nameOrPhone')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('schoolClass.specialityName')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:class:view')"
              :size="tableConfig.tableSearchSize"
              @click="clearHandle"
            >{{ $t('query') }}</el-button>
          </el-form-item>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:class:save')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="createHandle()"
            >{{ $t('add') }}</el-button>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:class:downloadExcel')"
              type="success"
              :size="tableConfig.tableSearchSize"
              @click="downloadHandle({
                i18nRequestMessage: 'downloadTemp',
                request: exportSchoolClass,
                data: {excelType: 2}
              })"
          ...
          <!--<el-form-item>
            <el-button
              v-if="filterPermission('school:class:export')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="exportHandle()"
            >{{ $t('export') }}</el-button>
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('school:class:delete')"
              type="danger"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('school:class:xxx')"
              type="danger"
              :size="tableConfig.tableSearchSize"
      ...
      <template slot="operate">
        ...
        >
          <template slot-scope="scope">
            <!-- 上下架 -->
            <!--<el-button
              v-if="filterPermission('school:class:display')"
              type="text"
              :size="tableConfig.tableSearchSize"
              @click="customHandle({
                data: {
            ...
            <!-- 修改 -->
            <el-button
              v-if="filterPermission('school:class:update')"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 上移 -->
            <!--<el-button
              v-if="filterPermission('school:class:exchange') && scope.$index !== 0"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 下移 -->
            <!--<el-button
              v-if="filterPermission('school:class:exchange') && scope.$index !== limit - 1"
              type="text"
              :size="tableConfig.tableSearchSize"
...
import { getSchoolClassPageList, deleteSchoolClass, exportSchoolClass, importSchoolClass } from '@/api/school/class'
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 班级名称
        { prop: 'className', label: 'schoolClass.className', width: '120' },
        // 所属专业
        { prop: 'specialityName', label: 'schoolClass.specialityName', width: '200' },
        // 所属学院
        { prop: 'branchName', label: 'schoolClass.branchName' },
        // 班主任
        { prop: 'classLinkMan', label: 'schoolClass.classLinkMan', width: '160' },
        // 联系电话
        { prop: 'classLinkPhone', label: 'schoolClass.classLinkPhone', width: '160' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      // 配置列表请求
      this.tableHandle.list.api = getSchoolClassPageList
      // this.tableHandle.list.callback = this.listCallback
      // 配置导出功能
      // this.tableHandle.export.api = exportXXX
      // 配置删除功能
      this.tableHandle.delete.api = deleteSchoolClass
      // this.tableHandle.delete.callback = this.deleteCallback
      // 配置节点懒加载功能
      // this.tableHandle.lazy.api = lazyXXX
      // 配置section删除功能
      // this.tableHandle.deleteSection.api = deleteSchoolClass
    ...
    genrateI18nSearchItems() {
      this.importConfig = {
        format: 0,
        uploadRequest: importSchoolClass,
