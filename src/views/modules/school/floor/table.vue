        ...
        >
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('schoolFloor.floorName')"
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('schoolFloor.buildingName')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-select
              ...
              :placeholder="$t('schoolFloor.buildingType')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            >
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:floor:view')"
              :size="tableConfig.tableSearchSize"
              @click="clearHandle"
            >{{ $t('query') }}</el-button>
          </el-form-item>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:floor:save')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="createHandle()"
            >{{ $t('add') }}</el-button>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('school:floor:downloadExcel')"
              type="success"
              :size="tableConfig.tableSearchSize"
              @click="downloadHandle({
                i18nRequestMessage: 'downloadTemp',
                request: exportSchoolFloor,
                data: {excelType: 2}
              })"
          ...
          <!--<el-form-item>
            <el-button
              v-if="filterPermission('school:floor:export')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="exportHandle()"
            >{{ $t('export') }}</el-button>
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('school:floor:delete')"
              type="danger"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('school:floor:xxx')"
              type="danger"
              :size="tableConfig.tableSearchSize"
      ...
      <template slot="operate">
        ...
        >
          <template slot-scope="scope">
            <!-- 上下架 -->
            <!--<el-button
              v-if="filterPermission('school:floor:display')"
              type="text"
              :size="tableConfig.tableSearchSize"
              @click="customHandle({
                data: {
            ...
            <!-- 修改 -->
            <el-button
              v-if="filterPermission('school:floor:update')"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 上移 -->
            <!--<el-button
              v-if="filterPermission('school:floor:exchange') && scope.$index !== 0"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 下移 -->
            <!--<el-button
              v-if="filterPermission('school:floor:exchange') && scope.$index !== limit - 1"
              type="text"
              :size="tableConfig.tableSearchSize"
...
import { getSchoolFloorPageList, deleteSchoolFloor, exportSchoolFloor, importSchoolFloor } from '@/api/school/floor'
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 楼层名称
        { prop: 'floorName', label: 'schoolFloor.floorName', width: '200' },
        // 楼栋名称
        { prop: 'buildingName', label: 'schoolFloor.buildingName', width: '400' },
        // 楼栋类型
        { prop: 'buildingTypeName', label: 'schoolFloor.buildingTypeName' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      // 配置列表请求
      this.tableHandle.list.api = getSchoolFloorPageList
      // this.tableHandle.list.callback = this.listCallback
      // 配置导出功能
      // this.tableHandle.export.api = exportXXX
      // 配置删除功能
      this.tableHandle.delete.api = deleteSchoolFloor
      // this.tableHandle.delete.callback = this.deleteCallback
      // 配置节点懒加载功能
      // this.tableHandle.lazy.api = lazyXXX
      // 配置section删除功能
      // this.tableHandle.deleteSection.api = deleteSchoolFloor
    ...
    genrateI18nSearchItems() {
      this.importConfig = {
        format: 0,
        uploadRequest: importSchoolFloor,
