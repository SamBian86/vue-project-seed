      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            >{{ $t('back') }}</el-button>
            <el-button
              v-if="containsPageType(['create']) && filterPermission('school:floor:save')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >{{ $t('add') }}</el-button>
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('school:floor:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >{{ $t('update') }}</el-button>
...
import { createSchoolFloor, editSchoolFloor, getSchoolFloorById } from '@/api/school/floor'
      ...
      this.formConfig.formItemsReadOnly = [
        ...
        },
        {
          ...
          componentConfig: {
            ...
            propName: 'buildingId',
            placeholder: 'schoolFloor.buildingId',
