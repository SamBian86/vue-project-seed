...
import { createEngineeringSupplierLinkhis } from '@/api/engineering/supplierLinkhis'
  ...
  data() {
    return {
      ...
      formHandle: {
        // 创建抽象方法，用创建接口方法覆盖
        create: {
          api: createEngineeringSupplierLinkhis
        },
        // 修改抽象方法，用修改接口方法覆盖
        edit: {
          // api: editXXX,
      ...
      this.formConfig.formItemsReadOnly = [
        {
          ...
          name: 'supplierLinkhis.supplierLinkman',
          type: 'text',
          rules: [{ required: true }]
        },
        {
          ...
          name: 'supplierLinkhis.supplierLinkphone',
          type: 'text',
          rules: [{ required: true }]
        }
      ]
