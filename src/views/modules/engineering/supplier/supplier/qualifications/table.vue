...
import {
  getEngineeringSupplierQualificationsPageList,
  deleteEngineeringSupplierQualifications
  ...
  methods: {
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 资质名称
        { prop: 'name', label: 'supplierQualifications.name', width: '160', align: 'center' },
        // 资质类别
      ...
      // 配置列表请求
      this.tableHandle.list.api = getEngineeringSupplierQualificationsPageList
      // 配置导出功能
      // this.tableHandle.export.api = exportXXX
      // 配置删除功能
      this.tableHandle.delete.api = deleteEngineeringSupplierQualifications
      // this.tableHandle.delete.callback = this.deleteCallback
      // 配置节点懒加载功能
      // this.tableHandle.lazy.api = lazyXXX
      // 配置section删除功能
      // this.tableHandle.deleteSection.api = deleteEngineeringSupplierQualifications
    ...
    editHandle(item, options = { componentNames: ['yunlin-table'] }) {
      const { supplierId } = this.tableSearchParams
      this.$pageSwitch('form', { ...item, pageType: 'edit', formDataUpdate: true, ...options, supplierId })
    }
  }
}
</script>
