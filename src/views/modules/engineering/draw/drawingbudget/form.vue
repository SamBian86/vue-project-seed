      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('engineering:draw:detail:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('engineering:draw:detail:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
...
import { editEngineeringDrawSubjectDetail } from '@/api/engineering/drawSubject'
  ...
  data() {
    return {
      ...
      formHandle: {
        ...
        // 修改抽象方法，用修改接口方法覆盖
        edit: {
          api: editEngineeringDrawSubjectDetail
        },
        // 详情抽象方法，用详情接口方法覆盖
        detail: {
          // api: getXXXById
      ...
      this.formConfig.formItemsReadOnly = [
        {
          // 强控比例
          span: 24,
          prop: 'drawingbudgetControlRate',
          name: 'draw.drawingbudgetControlRate',
          type: 'text'
        },
        {
          // 工程量
          span: 24,
          prop: 'drawingbudgetQuantities',
          name: 'draw.drawingbudgetQuantities',
          type: 'text'
        },
        {
          // 建筑单价(元)
          span: 24,
          prop: 'drawingbudgetUnivalence',
          name: 'draw.drawingbudgetUnivalence',
          type: 'text'
        },
        {
          // 建筑总价(元)
          ...
          name: 'draw.drawingbudgetTotalCost',
          type: 'text'
        },
        {
          // 单价说明
          span: 24,
          prop: 'drawingbudgetQuantitiesRemark',
          name: 'draw.drawingbudgetQuantitiesRemark',
          type: 'textarea',
