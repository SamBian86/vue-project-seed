        ...
        >
          <el-form-item>
            <el-select
              ...
              :placeholder="$t('statisticsContract.projectId')"
          ...
          <el-form-item>
            <el-date-picker
              ...
              :placeholder="$t('statisticsContract.dateFrom')"
              :size="tableConfig.tableSearchSize"
              type="date"
              format="yyyy-MM-dd"
          ...
          <el-form-item>
            <el-date-picker
              ...
              :placeholder="$t('statisticsContract.dateTo')"
              :size="tableConfig.tableSearchSize"
              type="date"
              format="yyyy-MM-dd"
              value-format="yyyy-MM-dd"
...
import { getEngineeringStatisticsContractPageList } from '@/api/engineering/statisticsContract'
  ...
  methods: {
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 合同大类
        { prop: 'pcontractTypeName', label: 'statisticsContract.pcontractTypeName', width: '160' },
        // 合同分类
        { prop: 'contractTypeName', label: 'statisticsContract.contractTypeName', width: '160' },
        // 合同编号
        { prop: 'contractCode', label: 'statisticsContract.contractCode', width: '120' },
        // 合同名称
        { prop: 'contractName', label: 'statisticsContract.contractName' },
        // 供应商
        { prop: 'supplierName', label: 'statisticsContract.supplierName', width: '120' },
        // 签约时间
        { prop: 'contractTime', label: 'statisticsContract.contractTime', width: '160' },
        // 合同额
        { prop: 'contractTotalPrice', label: 'statisticsContract.contractTotalPrice', width: '100' },
        // 变更额
        { prop: 'changeAmount', label: 'statisticsContract.changeAmount', width: '100' },
        // 终审额
        { prop: 'contractFinalPrice', label: 'statisticsContract.contractFinalPrice', width: '100' },
        // 应付总额
        { prop: 'needPayAmount', label: 'statisticsContract.needPayAmount', width: '100' },
        // 已付款
        { prop: 'havePayAmount', label: 'statisticsContract.havePayAmount', width: '100' },
        // 未付款
        { prop: 'unPayAmount', label: 'statisticsContract.unPayAmount', width: '100' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      // 配置列表请求
      this.tableHandle.list.api = getEngineeringStatisticsContractPageList
      // 配置导出功能
