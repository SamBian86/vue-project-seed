      ...
      <template slot="operate">
        ...
        >
          <template slot-scope="scope">
            ...
            <!-- 通过 -->
            <el-button
              v-if="filterPermission('engineering:contract:examine:pass') && scope.row.contractStatus === 1"
              type="text"
              :size="tableConfig.tableSearchSize"
              @click="customHandle({
            ...
            <!-- 退回操作 -->
            <el-button
              v-if="filterPermission('engineering:contract:examine:reject') && scope.row.contractStatus === 1"
              type="text"
              :size="tableConfig.tableSearchSize"
