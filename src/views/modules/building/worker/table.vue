        ...
        <el-form class="table-search-form" :inline="true" :model="tableSearchParams" @keyup.enter.native="searchHandle">
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('buildingWorker.deptName')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('buildingWorker.buildingName')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
...
import { getBuildingWorkerPageList, deleteBuildingWorker } from '@/api/building/worker'
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 宿管
        { prop: 'userName', label: 'buildingWorker.userName', width: '200' },
        // 手机号
        { prop: 'userPhone', label: 'buildingWorker.userPhone', width: '160' },
        // 所属组织
        { prop: 'deptName', label: 'buildingWorker.deptName', width: '120' },
        // 服务楼栋
        { prop: 'buildingNames', label: 'buildingWorker.buildingNames' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      // 配置列表请求
      this.tableHandle.list.api = getBuildingWorkerPageList
      // this.tableHandle.list.callback = this.listCallback
      // 配置导出功能
      // this.tableHandle.export.api = exportXXX
      // 配置删除功能
      this.tableHandle.delete.api = deleteBuildingWorker
      // this.tableHandle.delete.callback = this.deleteCallback
      // 配置节点懒加载功能
      // this.tableHandle.lazy.api = lazyXXX
      // 配置section删除功能
      // this.tableHandle.deleteSection.api = deleteBuildingWorker
