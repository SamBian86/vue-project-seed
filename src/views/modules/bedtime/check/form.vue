      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('bedtime:check:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('bedtime:check:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
...
import { getBedtimeCheckById } from '@/api/bedtime/check'
    ...
    init() {
      ...
      this.formConfig.formItemsReadOnly = [
        ...
        },
        {
          ...
          span: 24,
          prop: 'absentNum',
          name: 'bedtimeCheck.absentNum',
          type: 'text'
        },
        {
          // 分割线
          span: 24,
          name: 'bedtimeCheck.otherInfo',
          type: 'divider'
        },
        {
          // 缺席人员
