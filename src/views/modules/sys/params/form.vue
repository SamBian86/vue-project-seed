      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('sys:params:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('sys:params:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
...
import { createParams, editParams, getParamsById } from '@/api/sys/params'
