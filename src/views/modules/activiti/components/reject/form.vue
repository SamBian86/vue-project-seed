...
import { endProcessActivitiTask } from '@/api/activiti/task'
...
export default {
  ...
  data() {
    return {
      ...
      formHandle: {
        // 创建抽象方法，用创建接口方法覆盖
        create: {
          api: endProcessActivitiTask,
          callback: this.endProcessActivitiTaskCallback
        },
        // 修改抽象方法，用修改接口方法覆盖
        edit: {
          // api: editXXX,
  ...
  methods: {
    ...
    endProcessActivitiTaskCallback() {
      this.$drawerCloseByChild()
    }
  }
}
