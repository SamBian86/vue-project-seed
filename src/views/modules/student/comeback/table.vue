        ...
        <el-form class="table-search-form" :inline="true" :model="tableSearchParams" @keyup.enter.native="searchHandle">
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentComeback.nameOrPhoneOrNo')"
          ...
          <el-form-item>
            <el-select
              ...
              :placeholder="$t('studentComeback.branchId')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            >
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentComeback.className')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentComeback.buildingOrRoom')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:view')"
              :size="tableConfig.tableSearchSize"
              @click="searchHandle()"
            >
              {{ $t('query') }}
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:save')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="createHandle()"
            >
          ...
          <!--<el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:downloadExcel')"
              type="success"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- 导入 -->
          <!--<el-form-item>
            <button-import v-if="filterPermission('student:comeback:importExcel')" :config="importConfig"></button-import>
          </el-form-item>-->
          <!-- 清空选中 -->
          <!--<el-form-item>
            <el-button
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:export')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="exportHandle()"
            >
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:delete')"
              type="danger"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:comeback:xxx')"
              type="danger"
              :size="tableConfig.tableSearchSize"
      ...
      <template slot="operate">
        <el-table-column :label="$t('handle')" align="center" header-align="center" fixed="right" width="100">
          <template slot-scope="scope">
            <!-- 上下架 -->
            <!--<el-button
              v-if="filterPermission('student:comeback:display')"
              type="text"
              :size="tableConfig.tableSearchSize"
              @click="customHandle({
                data: {
            ...
            <!-- 修改 -->
            <!-- <el-button
              v-if="filterPermission('student:comeback:update')"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 上移 -->
            <!--<el-button
              v-if="filterPermission('student:comeback:exchange') && scope.$index !== 0"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 下移 -->
            <!--<el-button
              v-if="filterPermission('student:comeback:exchange') && scope.$index !== limit - 1"
              type="text"
              :size="tableConfig.tableSearchSize"
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 登记时间
        { prop: 'createDate', label: 'studentComeback.createDate', width: '160' },
        // 学生
        { prop: 'studentName', label: 'studentComeback.studentName', width: '100' },
        // 手机号
        { prop: 'studentPhone', label: 'studentComeback.studentPhone', width: '160' },
        // 宿舍楼
        { prop: 'buildingName', label: 'studentComeback.buildingName', width: '120' },
        // 宿舍号
        { prop: 'roomName', label: 'studentComeback.roomName', width: '120' },
        // 学院
        { prop: 'branchName', label: 'studentComeback.branchName' },
        // 班级名称
        { prop: 'className', label: 'studentComeback.className' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      this.tableSearchParams.lateType = 1
      // 配置列表请求
