      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('student:goout:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('student:goout:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
    ...
    init() {
      ...
      this.formConfig.formItemsReadOnly = [
        ...
        },
        {
          ...
          span: 24,
          prop: 'studentPhone',
          name: 'studentGoout.studentPhone',
          type: 'text'
        },
        {
          // 宿舍
        ...
        },
        {
          ...
          name: 'studentGoout.regulationsReason',
          type: 'textarea',
