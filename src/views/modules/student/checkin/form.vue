      ...
      >
        <template slot="footer">
          <div class="form-submit-container">
            ...
            <el-button
              v-if="containsPageType(['create']) && filterPermission('student:checkin:save')"
              type="primary"
              :size="formConfig.formSize"
            ...
            <el-button
              v-if="containsPageType(['edit']) && filterPermission('student:checkin:update')"
              type="primary"
              :size="formConfig.formSize"
              @click.stop="submitHandle"
            >
    ...
    init() {
      ...
      this.formConfig.formItemsReadOnly = [
        ...
        },
        {
          ...
          span: 24,
          prop: 'createDate',
          name: 'studentCheckin.createDate',
          type: 'text'
        },
        {
          // 学生
          span: 24,
          prop: 'studentName',
          name: 'studentCheckin.studentName',
          type: 'text'
        },
        {
          // 手机号
          span: 24,
          prop: 'studentPhone',
          name: 'studentCheckin.studentPhone',
          type: 'text'
        },
        {
          // 学号
        ...
        },
        {
          ...
          span: 24,
          prop: 'branchName',
          name: 'studentCheckin.branchName',
          type: 'text'
        },
        {
          // 班级
        ...
        },
        {
          ...
          span: 24,
          prop: 'buildingName',
          name: 'studentCheckin.buildingName',
          type: 'text'
        },
        {
          // 宿舍号
          span: 24,
          prop: 'roomName',
          name: 'studentCheckin.roomName',
          type: 'text'
        },
        {
          // 分割线
          span: 24,
          name: 'studentCheckin.otherInfo',
          type: 'divider'
        },
        {
          // 领用物品
          span: 24,
          prop: 'collectingList',
          name: 'studentCheckin.collectingList',
          type: 'page-component',
