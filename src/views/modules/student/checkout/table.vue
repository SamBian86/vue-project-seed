        ...
        <el-form class="table-search-form" :inline="true" :model="tableSearchParams" @keyup.enter.native="searchHandle">
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentCheckout.nameOrPhoneOrNo')"
          ...
          <el-form-item>
            <el-select
              ...
              :placeholder="$t('studentCheckout.branchId')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            >
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentCheckout.className')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-input
              ...
              :placeholder="$t('studentCheckout.buildingOrRoom')"
              :size="tableConfig.tableSearchSize"
              clearable
              @clear="clearHandle"
            ></el-input>
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:view')"
              :size="tableConfig.tableSearchSize"
              @click="searchHandle()"
            >
              {{ $t('query') }}
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:save')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="createHandle()"
            >
          ...
          <!--<el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:downloadExcel')"
              type="success"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- 导入 -->
          <!--<el-form-item>
            <button-import v-if="filterPermission('student:checkout:importExcel')" :config="importConfig"></button-import>
          </el-form-item>-->
          <!-- 清空选中 -->
          <!--<el-form-item>
            <el-button
          ...
          <el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:export')"
              type="primary"
              :size="tableConfig.tableSearchSize"
              @click="exportHandle()"
            >
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:delete')"
              type="danger"
              :size="tableConfig.tableSearchSize"
          ...
          <!-- <el-form-item>
            <el-button
              v-if="filterPermission('student:checkout:xxx')"
              type="danger"
              :size="tableConfig.tableSearchSize"
      ...
      <template slot="operate">
        <el-table-column :label="$t('handle')" align="center" header-align="center" fixed="right" width="100">
          <template slot-scope="scope">
            <!-- 上下架 -->
            <!--<el-button
              v-if="filterPermission('student:checkout:display')"
              type="text"
              :size="tableConfig.tableSearchSize"
              @click="customHandle({
                data: {
            ...
            <!-- 修改 -->
            <!-- <el-button
              v-if="filterPermission('student:checkout:update')"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 上移 -->
            <!--<el-button
              v-if="filterPermission('student:checkout:exchange') && scope.$index !== 0"
              type="text"
              :size="tableConfig.tableSearchSize"
            ...
            <!-- 下移 -->
            <!--<el-button
              v-if="filterPermission('student:checkout:exchange') && scope.$index !== limit - 1"
              type="text"
              :size="tableConfig.tableSearchSize"
  ...
  methods: {
    ...
    init() {
      ...
      this.tableConfig.tableHeadReadOnly = [
        // 离宿时间
        { prop: 'createDate', label: 'studentCheckout.createDate', width: '160' },
        // 学生姓名
        { prop: 'studentName', label: 'studentCheckout.studentName', width: '100' },
        // 手机号
        { prop: 'studentPhone', label: 'studentCheckout.studentPhone', width: '120' },
        // 学号
        { prop: 'studentNo', label: 'studentCheckout.studentNo', width: '120' },
        // 学院
        { prop: 'branchName', label: 'studentCheckout.branchName' },
        // 班级
        { prop: 'className', label: 'studentCheckout.className', width: '140' },
        // 楼栋
        { prop: 'buildingName', label: 'studentCheckout.buildingName', width: '140' },
        // 宿舍号
        { prop: 'roomName', label: 'studentCheckout.roomName', width: '140' }
      ]
      // 是否填充查询条件为空
      // this.tableConfig.searchFillEmpty = true
      // this.tableSearchParams = {}
      this.tableSearchParams.type = 2
      // 配置列表请求
