<template>
  <div :class="{ 'aui-theme-tools--open': isOpen }" class="aui-theme-tools">
...
export default {
  ...
  computed: {
    ...mapGetters(['layout_navbar_layoutType', 'layout_sidebar_layoutSkin'])
  },
  methods: {
    ...mapMutations('layout', ['setLayoutType', 'setLayoutSkin']),
    ...
    layoutTypeHandle(value) {
      this.setLayoutType(value)
    },
    layoutSkinHandle(value) {
      this.setLayoutSkin(value)
    }
  }
}
</script>
